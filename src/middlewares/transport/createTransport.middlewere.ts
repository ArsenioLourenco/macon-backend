...
export const createTransport= async (
  ...
  const schema=  Yup.object().shape({
      ...
      .required('o numero do transporte não foi inserendo'),
      totalPlace: Yup.number()
      .required('o total de espaço do transporte não foi inserendo'),
     typeTransport: Yup.number()
      .required('o tipo de transporte não foi inserendo')
  })
